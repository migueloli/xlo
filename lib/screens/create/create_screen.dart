              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  validator: (text) {
                    ...
                    var price = double.tryParse(getSanitizedText(text));
                    if (price == null) {
                  ...
                  onSaved: (p) => ad.price = double.parse(getSanitizedText(p)),
                ),
                HidePhoneWidget(
                  onSaved: (h) => ad.hidePhone = h,
                  initialValue: false,
                ),
                Container(
                  height: 50,
